...
export default class RealmCreatorScreen extends React.Component<Props, State> {
  ...
  private price: any
  private realmType: any

  constructor(props: Props) {
    super(props)
    this.realmType = this.props.navigation.getParam('realmType')
  ...
  // componentDidMount(){
  //   Zhugeio.startTrack('创建领域两步页面');
  // }

  // componentWillUnmount(){
  //   Zhugeio.endTrack('创建领域两步页面',{});
  // }
  ...
  render() {
    ...
    const nextDisabled = (step === 1 && title === '')
      || (step === 2 && (intro === '' || creatorIntro === ''))
      || (step === 3 && coverImageFileId === '' && coverImageUrl === '' && coverImageHexCode === '')
    return (
      <View
        style={{
          flex: 1,
        ...
        <View style={{ marginTop: convert(10), height: convert(20), justifyContent: 'center' }}>
              ...
              {step > 1 ?
                <View>
                  ...
                  <TextInput
                    ...
                    placeholder="介绍领域是关于什么的，为什么要创建它"
          ...
          <>
            <View
              ...
              <View style={{ alignItems: 'center', marginTop: coverImageFileId !== '' ? convert(23) : convert(50) }}>
                <Text style={{ fontSize: convert(35), fontWeight: '600', color: 'white' }}>为该领域设定</Text>
        ...
        >
          ...
          <TouchableOpacity
            style={{
              ...
              justifyContent: 'center',
              borderRadius: convert(10),
              backgroundColor: nextDisabled ? 'rgba(255,255,255,0.47)' : 'white'
            }}
