...
export const winHeight = isIos ? height : (StatusBar.currentHeight! > 25 ? Layout.screen.height : Layout.window.height)
...
export const convertX = (width: number) => width * HRatio;
export const convertY = (height: number) => height * VRatio;
export const convert = (number: number) => number * ratio;
